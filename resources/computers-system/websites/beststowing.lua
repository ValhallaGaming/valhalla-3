...
function www_beststowing_sa()
	...
	-- Text
	local article =  guiCreateLabel(10,318,440,410,"Welcome to BT&R's Website. Here you can learn about what BT&R is and what it does,\
...
-- Right Column
	...
	local footer_text = guiCreateLabel(14,739,254,14,"BT&R       2010 Best's Towing & Recovery. All Rights Reserved.",false,bg)
...
function www_beststowing_sa_aboutus()
	...
	---------------------
	local page_length = 764
	guiSetText(internet_address_label, "Best's Towing & Recovery - About")
